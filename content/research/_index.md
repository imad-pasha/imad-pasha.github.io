...
We build on this design, expanding to 120 lenses and adding ultranarrowband, tunable filters to the front of each lens, which can target the key optical emission lines from CGM gas for galaxies out to ~4000 km/s. 
